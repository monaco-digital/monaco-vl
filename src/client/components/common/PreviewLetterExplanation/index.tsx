...
const PreviewLetterExplanation: React.FC<Props> = ({ letter }: Props) => {
	...
	const lettersExplanationText = [
		...
		},
		{
			_RES: (
				<i>
					Well done! You have generated a further letter to send to your employer. Email this to yourself with the
					button below to fill in later. Then proceed to the next stage.
				</i>
			),
		},
	...
	const explanationText = lettersExplanationText.map(e => e[letterType]);
