...
import StatementSelectAcademy from '.';
...
describe('Statement Page', () => {
	...
	test('When Loading Statement Page Then Page renders', () => {
		renderWithProviders(<StatementSelectAcademy />, { initialState });
	});
	...
	test('Given No statements When Loading Statement Page Then automatically redirect to advice', async () => {
		...
		const { history } = renderWithProviders(<StatementSelectAcademy />, { initialState, startPage: '/statements' });
	...
	test('When Clicking back Then load previous page', async () => {
		const { history } = renderWithProviders(<StatementSelectAcademy />, { initialState, startPage: '/questions/1' });
