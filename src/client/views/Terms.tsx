...
export const Terms: React.FC = () => (
	<div className="termsSection" style={{ maxWidth: '900px' }}>
		...
		<p>
			Through Virtual Lawyer you are able to access a number of letters, including an advice letter, a without prejudice
			letter and a grievance letter. Those letters do not constitute specific legal advice, they only constitute general
			legal advice. If you need specific legal advice on the facts of your case then you should contact us and arrange
		...
		<p>
			...
			letter with you in writing then you are not our client, and you should not hold us out to be your lawyers to third
			parties.
		</p>
		<h2>For personal use only</h2>
		<p>
			Virtual Lawyer is for personal use only. If you work at an organisation wishing to use Virtual Lawyer for its own
			clients, please contact Monaco Solicitors and we will be very happy to hear from you. A non-personal licence may
			be very affordable, especially if you wish to contribute to the content of Virtual Lawyer.
		</p>
		<h2>Other</h2>
		<p>
			...
			<a href="mailto:communications@monacosolicitors.co.uk">communications@monacosolicitors.co.uk</a> for any queries.
		</p>
